...
public abstract class GameModel {
	protected BoardCell[][] board; //represents the game board
	 ...
	 */
	public void setBoardCell(int rowIndex, int colIndex, 
			BoardCell boardCell) {
	...
	//returns whether last row contains any non-empty cells
